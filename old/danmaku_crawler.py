...
class BilibiliDanmakuCrawler:
    ...
    def get_response(self, url, params):
        headers = {
            'cookie': "buvid3=02BCD2D1-8129-458C-A368-61A547780351167610infoc; b_nut=1641810078; blackside_state=1; CURRENT_FNVAL=4048; buvid4=88DF7015-38C5-514A-6AFE-3545F07A20C335687-022031319-tnbHT8NXYV66+VWxVRQjkg==; i-wanna-go-back=-1; rpdid=|(u)~lkRllmJ0J'uY~|J|)JRJ; CURRENT_QUALITY=16; DedeUserID=14912106; DedeUserID__ckMd5=b3e3a7794ac9f603; fingerprint=e2f3a1579282fcc61520136d52c16425; buvid_fp_plain=undefined; b_ut=5; buvid_fp=e2f3a1579282fcc61520136d52c16425; is-2022-channel=1; PVID=1; bp_video_offset_14912106=747598762403168300; nostalgia_conf=-1; innersign=0; b_lsid=4ED58F87_185B55309BD; bsource=search_bing; _uuid=D22D19CC-F18E-CF15-6545-1010D1F1A21AC996230infoc; SESSDATA=023bfd72,1689336398,fad2f*11; bili_jct=3d804d633efe41207c922808d926d6c4; sid=6zep113r".encode(
                'utf-8').decode('latin1'),
    ...
    def get_danmaku(self):
        for cid in tqdm(self.CID_DICT):
            ...
            date_former = "2023-01-15"
            with open(f"danmuku/{cid}.csv", "a") as f:
