...
GALLERY_PATH = '/Volumes/SSD/Data_demo/video/'

# 读取csv中的bvid、cid
video_list = pd.read_csv('/Volumes/SSD/Data_demo/getVideoinfo_demo.csv')
...
for bvid in tqdm(bvid_list):
    ...
    df.to_csv(GALLERY_PATH + '{}/{}.csv'.format(bvid, bvid), index=False)
